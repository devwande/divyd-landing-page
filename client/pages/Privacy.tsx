      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg">
            <p className="">
              Privacy Policy content will be available when Spot launches. We
              take your privacy seriously and will provide complete details
              about how we handle your data before public release.
            </p>
          </div>
        </div>
      </div>
